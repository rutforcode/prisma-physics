...
export const RESOURCES: PhysicsResource[] = [
  ...
  {
    id: "physics-magazine",
    name: "Physics Magazine (APS)",
    description:
      "The American Physical Society's free online magazine — research highlights, explainers, and commentary from every corner of physics.",
    url: "https://physics.aps.org/",
    domain: "physics.aps.org",
    category: "Articles",
    topics: ["Modern Physics", "Quantum Physics", "Astrophysics", "Nuclear Physics", "Experimental Physics"],
    levels: ["intermediate", "advanced"],
    badges: ["Free", "University Level"],
    featured: false,
    tags: ["News", "Research", "Explainer"],
    source: "American Physical Society",
    addedAt: "2026-08-16",
    score: 88,
  },
  {
    id: "sciam-physics",
    name: "Scientific American — Space & Physics",
    description:
      "Accessible, deeply reported physics coverage — from quantum experiments to cosmology — by one of the oldest science magazines in print.",
    url: "https://www.scientificamerican.com/space-and-physics/",
    domain: "scientificamerican.com",
    category: "Articles",
    topics: ["Modern Physics", "Astrophysics", "Quantum Physics"],
    levels: ["intro", "intermediate"],
    badges: ["Beginner Friendly"],
    featured: false,
    tags: ["News", "Magazine", "Cosmology"],
  ...
  {
    id: "quanta-magazine",
    name: "Quanta Magazine — Physics",
    description:
      "Award-winning coverage of modern physics and mathematics — deep, careful explainers of the ideas at the frontiers of research.",
    url: "https://www.quantamagazine.org/physics/",
    domain: "quantamagazine.org",
    category: "Articles",
    topics: ["Modern Physics", "Quantum Physics", "Mathematical Physics", "Astrophysics"],
    levels: ["intermediate"],
    badges: ["Free"],
    featured: false,
    tags: ["News", "Research", "Mathematics"],
  ...
  },
  {
    ...
    description:
      "A daily feed of physics research news — condensed summaries of new papers across condensed matter, particle, and applied physics.",
    url: "https://phys.org/physics-news/",
    domain: "phys.org",
    category: "Articles",
    topics: ["Modern Physics", "Astrophysics", "Nuclear Physics", "Experimental Physics"],
    levels: ["intro", "intermediate"],
    badges: ["Free"],
    featured: false,
  ...
  {
    id: "science-news",
    name: "Science News — Physics",
    description:
      "Independent, accurate reporting on physics research and discovery — clear summaries of new results for a broad audience.",
    url: "https://www.sciencenews.org/topic/physics",
    domain: "sciencenews.org",
    category: "Articles",
    topics: ["Modern Physics", "Quantum Physics", "Astrophysics", "Experimental Physics"],
    levels: ["intro", "intermediate"],
    badges: ["Free"],
    featured: false,
    tags: ["News", "Research", "Reporting"],
  ...
  },
  {
    ...
    name: "3Blue1Brown",
    description:
      "Visual explanations of mathematics and physics — animated, intuition-first videos that make calculus, linear algebra, and more click.",
    url: "https://www.3blue1brown.com/",
    domain: "3blue1brown.com",
    category: "Learning",
    topics: ["Mathematical Physics", "Mechanics", "Waves & Oscillations", "Optics"],
    levels: ["intro", "intermediate"],
    badges: ["Recommended", "Free", "Beginner Friendly"],
    featured: true,
    tags: ["Videos", "Visualization", "Intuition"],
  ...
  },
  {
    ...
    name: "Brilliant",
    description:
      "Interactive problem-based courses in physics and math — learn by solving, with instant feedback on every step.",
    url: "https://brilliant.org/",
    domain: "brilliant.org",
    category: "Learning",
    topics: ["Mathematical Physics", "Mechanics", "Electromagnetism", "Quantum Physics"],
    levels: ["intro", "intermediate"],
    badges: ["Interactive", "Beginner Friendly"],
    featured: false,
    tags: ["Courses", "Problem Solving", "Interactive"],
    source: "Brilliant",
    addedAt: "2026-08-15",
    score: 82,
  },
  {
    id: "open-yale",
    name: "Open Yale Courses — Physics",
    description:
      "Free, full-semester Yale physics lectures — complete courses in mechanics, electromagnetism, and modern physics with problem sets.",
    url: "https://oyc.yale.edu/physics",
    domain: "oyc.yale.edu",
    category: "Learning",
    topics: ["Mechanics", "Electromagnetism", "Modern Physics", "Quantum Physics", "Thermodynamics"],
    levels: ["intermediate"],
    badges: ["Free", "University Level"],
    featured: false,
    tags: ["Lectures", "University", "Courses"],
  ...
  },
  {
    ...
    name: "Sixty Symbols",
    description:
      "Physicists at the University of Nottingham explain the symbols, ideas, and stories of physics — filmed in labs, not studios.",
  ...
  },
  {
    ...
    name: "BIPM — SI Units",
    description:
      "The official source of the International System of Units — the definitions behind every measurement, straight from the BIPM.",
    url: "https://www.bipm.org/en/measurement-units",
    domain: "bipm.org",
    category: "Reference",
    topics: ["Experimental Physics", "Mathematical Physics"],
    levels: ["intermediate", "advanced"],
    badges: ["Free", "University Level"],
    featured: false,
    tags: ["Units", "Standards", "Measurement"],
  ...
  },
  {
    ...
    description:
      "The authoritative review of particle physics — the PDG booklet and database of particle properties, constants, and experimental results.",
    url: "https://pdg.lbl.gov/",
    domain: "pdg.lbl.gov",
    category: "Reference",
    topics: ["Nuclear Physics", "Quantum Physics", "Modern Physics", "Experimental Physics"],
    levels: ["advanced"],
    badges: ["Free", "University Level"],
    featured: false,
    tags: ["Particle Physics", "Data", "Review"],
  ...
  },
  {
    ...
    description:
      "The international standard for terminology, symbols, and units in chemistry and physics — precise definitions for lab and theory work.",
    url: "https://goldbook.iupac.org/",
    domain: "goldbook.iupac.org",
    category: "Reference",
    topics: ["Experimental Physics", "Quantum Physics", "Thermodynamics", "Mathematical Physics"],
    levels: ["advanced"],
    badges: ["Free", "University Level"],
    featured: false,
    tags: ["Terminology", "Definitions", "Standards"],
  ...
  },
  {
    ...
    name: "ESA/Hubble",
    description:
      "Hubble Space Telescope imagery, videos, and educational resources from the European Space Agency — the universe in stunning detail.",
    url: "https://esahubble.org/",
    domain: "esahubble.org",
    category: "Visualization",
    topics: ["Astrophysics", "Modern Physics"],
    levels: ["intro"],
    badges: ["Free", "Beginner Friendly"],
    featured: false,
    tags: ["Space", "Imagery", "Telescope"],
  ...
  },
  {
    ...
    description:
      "A new astronomical image every day with a short expert explanation — a daily window into astrophysics since 1995.",
  ...
  {
    id: "omni-calculator",
    name: "Omni Calculator — Physics",
    description:
      "Hundreds of ready-to-use physics calculators — kinematics, circuits, thermodynamics — with units handled for you.",
    url: "https://www.omnicalculator.com/physics",
    domain: "omnicalculator.com",
    category: "Calculators",
    topics: ["Mechanics", "Electromagnetism", "Thermodynamics", "Modern Physics"],
    levels: ["intro", "intermediate"],
    badges: ["Free", "Beginner Friendly"],
    featured: false,
    tags: ["Calculators", "Units", "Problem Solving"],
  ...
  },
  {
    ...
    name: "RapidTables",
    description:
      "Quick unit conversions, constants, and formula references — ideal for lab work and problem sets where units trip you up.",
    url: "https://www.rapidtables.com/",
    domain: "rapidtables.com",
    category: "Calculators",
    topics: ["Mechanics", "Electromagnetism", "Experimental Physics"],
    levels: ["intro"],
    badges: ["Free", "Beginner Friendly"],
    featured: false,
    tags: ["Conversions", "Constants", "Reference"],
    source: "RapidTables",
    addedAt: "2026-08-12",
    score: 72,
  },
  {
    ...
    name: "Matplotlib",
    description:
      "The standard Python plotting library — publication-quality graphs of data, functions, and experimental results with full control.",
    ...
    badges: ["Free", "Open Source"],
    featured: false,
    tags: ["Plotting", "Data Visualization", "Open Source"],
    source: "Matplotlib Project",
    addedAt: "2026-08-12",
    score: 83,
  },
  {
    ...
    name: "Jupyter",
    description:
      "Interactive notebooks for reproducible physics — combine code, equations, plots, and prose in one live document.",
    ...
    badges: ["Free", "Open Source", "Interactive"],
    featured: false,
    tags: ["Notebooks", "Reproducibility", "Open Source"],
  ...
  },
  {
    ...
    name: "SymPy",
    description:
      "Symbolic mathematics in Python — derivatives, integrals, equation solving, and LaTeX output for derivations done by hand.",
    ...
    badges: ["Free", "Open Source"],
    featured: false,
    tags: ["Symbolic Math", "CAS", "Open Source"],
    source: "SymPy Project",
    addedAt: "2026-08-12",
    score: 79,
  },
  {
    ...
    description:
      "Clean, focused HTML5 physics applets — pendulums, lenses, circuits, and more — simple interactive demos that just work.",
    url: "https://www.walter-fendt.de/html5/phen/",
    domain: "walter-fendt.de",
    category: "Simulators",
    topics: ["Mechanics", "Waves & Oscillations", "Optics", "Electromagnetism"],
    levels: ["intro"],
    badges: ["Free", "Interactive", "Beginner Friendly"],
    featured: false,
    tags: ["Applets", "HTML5", "Interactive"],
    source: "Walter Fendt",
    addedAt: "2026-08-12",
    score: 76,
  },
